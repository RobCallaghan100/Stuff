...
namespace WebApi2Book.Web.Api.Security
{
    public class BasicAuthenticationMessageHandler : DelegatingHandler
    {
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            {
                _log.Debug("Already authenticated; passing on next handler...");
            ...
            if (isAuthenticated)
            {
                ...
                return response.StatusCode == HttpStatusCode.Unauthorized ? CreateUnauthorisedResponse() : response;
            }

            return CreateUnauthorisedResponse();
        }

        private HttpResponseMessage CreateUnauthorisedResponse()
        {
